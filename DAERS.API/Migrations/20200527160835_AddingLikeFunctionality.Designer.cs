...
namespace DAERS.API.Migrations
{
    ...
    [Migration("20200527160835_AddingLikeFunctionality")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DAERS.API.Models.Like", b =>
                {
            ...
            modelBuilder.Entity("DAERS.API.Models.Like", b =>
                {
                    b.HasOne("DAERS.API.Models.User", "Likee")
                        .WithMany("Likers")
                        .HasForeignKey("LikeeId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("DAERS.API.Models.User", "Liker")
                        .WithMany("Likees")
